...
> **Public LB 0.95104** (프로젝트 파이프라인 최고) · 완전 독립 후보 최고 **0.95063** · 11개 모델 및 40여 개 실험 축 비교
...
- 프로젝트 파이프라인 최고: **Co_5 / Co_9 / Co_10 = 0.95104**
- 완전 독립 후보 최고: **Co_L3 = 0.95063**
- `Co_16 = 0.95114`는 제공받은 `A_F.csv`와 바이트 단위로 동일하고 공개 컨센서스 제출과 3행만 달라 **프로젝트 성과에서 제외**
...
| N2 | **HistGB + exact-value TE ×5시드** | **0.95051** | **0.94982** | TE가 +0.0008 |
...
| N9 | HGB-TE + RealMLP + K 중첩 블렌드 | 0.95088 | 0.95089 | CV↔LB 갭 0.00001 |
| Co_5/9/10 | 수면·수분·활동 라우팅 및 5-fold 컨센서스 | - | **0.95104** | 프로젝트 파이프라인 최고 |
| Co_L3 | 완전 독립 unhealthy 공격 후보 | 0.95082 | **0.95063** | 독립 후보 최고 |

**방법론 원칙**: 채택 기준 = 중첩검증 정직 이득 +0.0005 이상 · 모든 튜닝은 OOF 내부 · 외부 제출 파일은 모델 성과와 분리 · Public LB와 OOF를 함께 보고 순위 역전 여부까지 기록

## ⚠️ 한계

- 합성데이터와 Public 20% 분할 특성상 OOF↔LB 순위 역전이 있었으며, 실세계 일반화 검증은 아님
